...
\include{content/2_wifi_basics}
\include{content/3_device_architecture}
\include{content/4_worklog}
\include{content/5_wifi_attacks}
\include{content/6_penetration_testing}
\include{content/7_educational_use}
...
\includepdf{userguide/userguide.pdf}
