...
\begin{frame}{Architektur}
    \begin{columns}
        \begin{column}{0.4\textwidth}
            \begin{figure}
                \centering
                \includegraphics[width=\columnwidth]{figures/OSImodel.png}
            \end{figure}
...
\begin{frame}{Architektur}
    \begin{columns}
        \begin{column}{0.3\textwidth}
            ...
            \\\vspace{0.5cm}
            \includegraphics[width=.8\columnwidth]{figures/BSS.pdf}
        \end{column}
        \begin{column}{0.6\textwidth}
            \textbf{MAC Frame}
            \\\vspace{0.5cm}
            \includegraphics[width=\columnwidth]{figures/MAC_frame.pdf}
            \\\vspace{0.5cm}
...
\begin{frame}{Sicherheit}
    ...
    \begin{columns}
        \begin{column}{.6\textwidth}
           ...
           \\\vspace{0.3cm}
           \includegraphics[width=.9\columnwidth]{figures/RC4.pdf}
           \tiny
        ...
        \begin{column}{.4\textwidth}
           ...
           \\\vspace{0.6cm}
           \includegraphics[width=.9\columnwidth]{figures/wep_authentication.jpg}
           \tiny
