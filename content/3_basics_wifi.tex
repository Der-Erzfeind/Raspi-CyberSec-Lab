...
\section{MAC layer}
Devices in the MAC layer are adressed with a MAC address, which consists of 12 hexdecimal characters and is unique for every network interface controller (NIC).
