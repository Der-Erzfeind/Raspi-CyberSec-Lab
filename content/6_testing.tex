...
Once the desired AP has been discovered, similar to Cracking WEP, \lstinline[]|airodump-ng| is used to capture the (re-)authentication handshake.
...
\\\lstinline[]|-c| can be used to specify the MAC address of a STA, to send the frames directly to one STA, as recommended by the program
