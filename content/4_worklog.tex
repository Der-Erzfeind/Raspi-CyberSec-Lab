...
Off the shelf rotary encoders have clicks similar to the scrolling wheel of a computer mouse and according to various online tutorials, the encoder switches one state on each click.
