...
As described in \cref{sec:ui}, the setup without a graphic server does limit the scaling of the UI to adjusting the resolution in the display configuration in config.txt.
...
\begin{itemize}
    \item Adding battery power would improve the portability of the device, but would most likely also require a more efficient SBC than the RPI.
    ...
    \item The addition of defensive features like an Intrusion Detection and Prevention System would be a great way of teaching the application of cyber security priciples.
