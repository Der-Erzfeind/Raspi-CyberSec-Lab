...
\section{Overview}
\begin{itemize}
    \item \cref{ch:basics_cybersec} explains the principles of it security and the difference between Cybersecurity and its security.
    ...
    \item \cref{ch:documentation} explains the architecture of the hardware and software of the RCSL.
    ...
    \item \cref{ch:discussion} outlines the challenges of Cybersecurity education and discusses use cases for the RCSL in the field.
\end{itemize}