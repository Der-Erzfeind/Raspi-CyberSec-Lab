...
\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{figures/Abbildungen/Devices.png}
    \label{fig:devices}
...
\begin{figure}[h]
    ...
    \includegraphics[width=0.3\linewidth]{figures/Abbildungen/hackerypi/menu_wifi.png}
...
\begin{figure}[h]
    \includegraphics[width=0.3\linewidth]{figures/Abbildungen/hackerypi/status_wifi.png}
    \includegraphics[width=0.3\linewidth]{figures/Abbildungen/hackerypi/activate_monitor.png}
    \centering
