...
For example, the User turns the the encoder one click clockwise, therefore main receives one downwards error symbol and the selections moves to the next option below.
