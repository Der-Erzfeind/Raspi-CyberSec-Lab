...
Because the prerequisites for PSK derivation are transmitted during the handshake on connection establishment, PSK is vulnerable to offline and dictionary attacks, therefore WPA3 replaces it with Simultaneous Authentication of Equals (SAE).
