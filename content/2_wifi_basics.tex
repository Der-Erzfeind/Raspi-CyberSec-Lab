...
BSS describes the most comman and basic configuration, where multiple STAs are connected to one AP, which has wired connection to the internet.
...
The header contains information about the source and destination, the frame type or power management
