...
WPA still used RC4 for compatibility reasons, but the encryption is based on a pairwise master key, which is generated for each STA after it has authenticated successfully.
